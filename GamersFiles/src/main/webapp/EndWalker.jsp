...
<html>
	...
	<body class="is-preload">
		...
		<!-- Header -->
			<header id="header">
				<div class="inner">
					<a href="#" class="image avatar"><img src="images/con_logo5.png" alt="" /></a>
					...
					<section id="two">
						...
						<div class="row">
							<article class="col-6 col-12-xsmall work">
								<a href="pandem1.html" class="image fit thumb"><img src="images/헤스(영식).jpg" alt="" /></a>
								<h3>마의 전당 판데모니움 : 변옥편(영웅)</h3>
								<p>변옥편(영웅) 1~4</p>
							</article>
							<article class="col-6 col-12-xsmall work">
								<a href="pandem2.html" class="image fit thumb"><img src="images/드라군.jpg" alt="" /></a>
