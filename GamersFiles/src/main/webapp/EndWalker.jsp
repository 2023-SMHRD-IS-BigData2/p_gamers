			...
			<div id="main">
				...
				<!-- One -->
					<section id="one">
						...
						<p>과거 템페스트에서 손에 넣은 것과 매우 흡사한 결정이 별바다에서 발견되었다. 결정에 깃든 기억에서 '판데모니움에 위기가 닥쳤다' 라는 말이 들려오고, 이를 조사하고자 엘피스로 간 모험가는 테미스라는 청년을 만난다. 그가 말하길 '판데모니움'이란 위험한 창조 생물을 수용하는 시설이며, 얼마 전부터 내부와 연락이 끊겼다고 한다. 영문 모를 위기의 근원을 찾기 위해, 모험가는 테미스와 함께 '판데모니움'으로 향한다</p>
