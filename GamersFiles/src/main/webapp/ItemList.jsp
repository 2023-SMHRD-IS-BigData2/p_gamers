...
<body>
	...
	<div class="table-tltle">
		...
		<button onclick="showtable1()">변옥 드롭 아이템</button>
		<button onclick="showtable2()">연옥 드롭 아이템</button>
		<button onclick="showtable3()">천옥 드롭 아이템</button>
	</div>
	...
	<div class="table-container">
		<table border="1" id="table2">
			...
			<% for(ItemDTO items2 : I_List2){ %>
			<tr class="contents">
                   <td><%= items2.getItem_name() %></td>
                   <td><%= items2.getItem_level() %></td>
                   <td><%= items2.getEquip_level() %></td>
                   <td><%= items2.getDrop_location() %></td>
             </tr>
             <%} %>
		</table>
	</div>
	<div class="table-container">
		<table border="1" id="table3">
			...
			<% for(ItemDTO items3 : I_List){ %>
			<tr class="contents">
                   <td><%= items3.getItem_name() %></td>
                   <td><%= items3.getItem_level() %></td>
                   <td><%= items3.getEquip_level() %></td>
                   <td><%= items3.getDrop_location() %></td>
             </tr>
             <%} %>
		</table>
	</div>
