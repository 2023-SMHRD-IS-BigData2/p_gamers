...
<body>
	...
	<div id="detail_titel">
		<span class="col1">제목</span> <span class="col2"><%=message.getE_title()%></span>
		<span class="col3">보낸일시</span>
	</div>
	<div id="detail_ti">
		<span class="col1">보낸이</span> <span class="col2"><%=message.getE_recipient()%></span>
	...
	<div id="detail_con">
		<span class="col1"></span> <span class="col2"><%=message.getE_content()%></span>
	</div>
	<div id="detail_re">
		<span class="col1"></span> <span class="col2"></span> <span
			class="col3"><a href="Message.jsp">돌아가기</a></span> <span></span>
	</div>
	</div>
	</section>
	</setion>
